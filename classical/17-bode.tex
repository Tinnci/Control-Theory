...
\hline
\rowcolor{blue!15}
\textbf{环节} & \textbf{传递函数} & \textbf{转折频率} & \textbf{幅频特性} & \textbf{相频特性} \\
\hline

\rowcolor{gray!8}
\textbf{比例} & $K$ & — & $0$ dB/dec & $0°$ 或 $180°$ \\
\hline
...
$0 \text{ dB/dec}$ ($\omega<\omega_c$) 或 $-20 \text{ dB/dec}$ ($\omega>\omega_c$) & 
$-45°$ @ $\omega_c$ \\
\hline
...
$0 \text{ dB/dec}$ ($\omega<\omega_n$) 或 $-40 \text{ dB/dec}$ ($\omega>\omega_n$) & 
$-90°$ @ $\omega_n$ \\
\hline
