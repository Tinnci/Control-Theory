...
\hline
\textbf{输入影响} & ✓ 能控制 & ✓ 能控制 & ✗ 无法控制 & ✗ 无法控制 \\
\hline
\textbf{输出可见} & ✓ 可观测 & ✗ 隐藏 & ✓ 可观测 & ✗ 隐藏 \\
\hline
\textbf{$B$矩阵} & $B_1 \neq 0$ & $B_2 \neq 0$ & $B_3 = 0$ & $B_4 = 0$ \\
\hline
\textbf{$C$矩阵} & $C_1 \neq 0$ & $C_2 = 0$ & $C_3 \neq 0$ & $C_4 = 0$ \\
\hline
\textbf{传递函数贡献} & ✓ \textbf{唯一贡献} & ✗ 不出现 & ✗ 不出现 & ✗ 不出现 \\
\hline
\textbf{极点配置} & ✓ 可任意配置 & ✓ 可配置 & ✗ 无法配置 & ✗ 无法配置 \\
\hline
\textbf{状态估计} & ✓ 可设计观测器 & ✗ 无法估计 & ✓ 可估计 & ✗ 无法估计 \\
\hline
\textbf{稳定性影响} & 
需保证稳定 
& 
...
\hline
\textbf{实际类比} & 
\textquotedblleft 可见可控\textquotedblright
\newline 驾驶员控制方向盘
& 
\textquotedblleft 瞎子控制\textquotedblright
\newline 踩油门但看不到速度表
& 
\textquotedblleft 旁观者\textquotedblright
\newline 看温度但无法调节
& 
\textquotedblleft 盲区炸弹\textquotedblright
\newline 隐藏的不稳定振动
\\
\hline
