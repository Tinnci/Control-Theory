...
% 绘制圆（半径为 ω_n）
\addplot[dashed, gray, thick, domain=0:360, samples=150] 
    ({-1 + 2*cos(x)}, {2*sin(x)});

% 特征根位置（示例：ζ=0.5, ω_n=2）
\addplot[red, mark=*, mark size=7pt, only marks] 
    coordinates {(-1, 1.732) (-1, -1.732)};

% 从原点到特征根的连线（模为 ω_n）
\addplot[black, thin, dashed] coordinates {(0, 0) (-1, 1.732)};
\addplot[black, thin, dashed] coordinates {(0, 0) (-1, -1.732)};

% 圆弧表示 ω_n（模）
\addplot[black, thick, domain=0:60, samples=50] 
    ({2*cos(x)}, {2*sin(x)});
\addlegendentry{模 $|\omega_n|$}

% 从虚轴垂直线到特征根
\addplot[blue, thin, line width=1.5pt] coordinates {(-1, 0) (-1, 1.732)};
\addplot[blue, thin, line width=1.5pt] coordinates {(-1, 0) (-1, -1.732)};
\addlegendentry{实部 $-\zeta\omega_n$}

% 虚部水平线
\addplot[green!60!black, thin, line width=1.5pt] coordinates {(-1, 1.732) (-0.5, 1.732)};
\addplot[green!60!black, thin, line width=1.5pt] coordinates {(-1, -1.732) (-0.5, -1.732)};
\addlegendentry{虚部 $\pm\omega_d$}
...
\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=具体例：欠阻尼二阶系统 $G(s) = \dfrac{25}{s^2+5s+25}$,boxsep=3pt,left=3pt,right=3pt,top=3pt,bottom=3pt]
