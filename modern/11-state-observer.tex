...
\begin{tcolorbox}[colback=green!5!white, colframe=green!60!black, title=\textbf{🔄 对偶性——观测器设计的"免费午餐"}, breakable]
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!60!black, title=\textbf{第二步：选择观测器极点}, breakable]
...
\begin{tcolorbox}[colback=purple!5!white, colframe=purple!75!black, title=\textbf{第三步：计算观测器增益 $L$}, breakable]
...
\begin{tcolorbox}[colback=orange!5!white, colframe=orange!75!black, title=\textbf{第四步：验证设计}, breakable]
...
\begin{tcolorbox}[colback=red!5!white, colframe=red!75!black, title=\textbf{⚠️ 极点配置的实际限制——不是越快越好！}, breakable]
...
\begin{align*}
\dot{x} &= Ax + Bu \\
        &= Ax + B(-K\hat{x}) \quad \text{\small （代入控制律）} \\
        &= Ax - BK(x - e) \quad \text{\small （因为 $\hat{x} = x - e$）} \\
        &= (A - BK)x + BKe \quad \text{\small （整理）}
\end{align*}
...
计算闭环矩阵：
\begin{align*}
A - BK &= \begin{bmatrix} 0 & 1 \\ 0 & -1 \end{bmatrix} - \begin{bmatrix} 0 \\ 1 \end{bmatrix} [k_1 \quad k_2] \\
&= \begin{bmatrix} 0 & 1 \\ 0 & -1 \end{bmatrix} - \begin{bmatrix} 0 & 0 \\ k_1 & k_2 \end{bmatrix} \\
&= \begin{bmatrix} 0 & 1 \\ -k_1 & -1-k_2 \end{bmatrix}
\end{align*}
...
设 $L = \begin{bmatrix} l_1 \\ l_2 \end{bmatrix}$，计算误差矩阵：

\begin{align*}
A - LC &= \begin{bmatrix} 0 & 1 \\ 0 & -1 \end{bmatrix} - \begin{bmatrix} l_1 \\ l_2 \end{bmatrix} [1 \quad 0] \\
&= \begin{bmatrix} 0 & 1 \\ 0 & -1 \end{bmatrix} - \begin{bmatrix} l_1 & 0 \\ l_2 & 0 \end{bmatrix} \\
&= \begin{bmatrix} -l_1 & 1 \\ -l_2 & -1 \end{bmatrix}
\end{align*}
