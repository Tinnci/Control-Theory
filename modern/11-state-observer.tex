...
\subsubsection{3. 控制器设计（基于分离定理的第一步）}
...
\subsubsection{4. 观测器设计（基于分离定理的第二步）}
...
状态观测器是现代控制理论的\textbf{基石之一}。它将第5章的能观测性理论转化为实际的估计算法，与第10章的极点配置方法结合，通过分离定理构成了完整的状态反馈控制系统。
