...
\usepackage[colorlinks=true, linkcolor=sagegreen, urlcolor=sagegreen, citecolor=sagegreen, filecolor=sagegreen, bookmarks=true, bookmarksnumbered=true]{hyperref}
